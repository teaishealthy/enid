...
function App() {
  return (
    <div>
      <div className="sticky top-0 z-50 flex h-16 items-center justify-between bg-white px-72">
      ...
      <div
        ...
        style={{
          backgroundImage:
            'linear-gradient(to top, rgb(255 255 255), rgb(0 0 0 / 0%)), url(https://images.unsplash.com/photo-1454496522488-7a8e488e8606)',
        }}
      >
